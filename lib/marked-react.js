...
var ReactRenderer = exports.ReactRenderer = function (_marked$Renderer) {
    ...
    _createClass(ReactRenderer, [{
        key: 'normalizeText',
        value: function (_normalizeText) {
            function normalizeText(_x) {
                return _normalizeText.apply(this, arguments);
            }

            normalizeText.toString = function () {
                return _normalizeText.toString();
            };
            ...
            if (Array.isArray(text) && _lodash2.default.every(text, function (t) {
