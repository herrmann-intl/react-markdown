...
var ReactRenderer = exports.ReactRenderer = function (_marked$Renderer) {
    ...
    _createClass(ReactRenderer, [{
        ...
        value: function normalizeText(text) {
            ...
            var collection = text.length == 1 && Array.isArray(text[0]) ? text[0] : text;

            if (this.textPreprocessor && _lodash2.default.every(collection, function (t) {
                return typeof t == "string";
            })) {
                return this.textPreprocessor(collection.join(" "));
            } else if (this.textPreprocessor && collection) {
                return collection.map(function (t) {
                    return typeof t == "string" ? _this2.textPreprocessor(t) : t;
                });
            } else {
                return collection;
            }
